...
// SQL query to fetch data from row 13 to 18 in the table
$sql = "SELECT * FROM recipes LIMIT 6 OFFSET 12";  // Fetch 6 records starting from the 13th record
...
$recipe_links = [
    'r13.html',  // Link for the first recipe (13th record)
    'r14.html',  // Link for the second recipe (14th record)
    'r15.html', 
    'r16.html',
    'r17.html',
    'r18.html',
...
<header>
        <nav>
            ...
            <div class="heading">
                <h1>Senpai's Dessert recipes</h1>
            </div>
        </nav>
    </header>
    <br>
