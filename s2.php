...
// SQL query to fetch data from row 7 to 12 in the table
$sql = "SELECT * FROM recipes LIMIT 6 OFFSET 6";  // Fetch 6 records starting from the 7th record
...
$recipe_links = [
    'r7.html',  // Link for the first recipe (7th record)
    'r8.html',  // Link for the second recipe (8th record)
    'r9.html', 
    'r10.html',
    'r11.html',
    'r12.html',
...
<header>
        <nav>
            ...
            <div class="heading">
                <h1>Senpai's Starter Recipes</h1>
            </div>
        </nav>
    </header>
    <br>
